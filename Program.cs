...
{
    private static readonly Version CurrentVersion = new(2, 0, 13);
...
internal sealed class GraphForm : Form
{
    ...
    public GraphForm(UsageSnapshot current, List<UsageSnapshot> history, int refreshMinutes, int graphDays, Action<int> refreshChanged, Action<int> durationChanged, ResetData? resetData, Action showAnalytics)
    {
        ...
        header.Controls.Add(new Label { Text = "Codex limits", AutoSize = true, Location = new Point(34, 18), Font = new Font("Segoe UI", 28, FontStyle.Bold, GraphicsUnit.Pixel), ForeColor = Color.White });
        resetChanceValue = new Label { AutoSize = true, Location = new Point(36, 62), Font = new Font("Segoe UI", 15, FontStyle.Bold, GraphicsUnit.Pixel), ForeColor = Color.FromArgb(255, 190, 70) }; header.Controls.Add(resetChanceValue);
        lastResetValue = new Label { AutoSize = true, Location = new Point(410, 62), Font = new Font("Segoe UI", 15, FontStyle.Regular, GraphicsUnit.Pixel), ForeColor = Color.FromArgb(190, 190, 200) }; header.Controls.Add(lastResetValue);
        header.Controls.Add(new Label { Text = "WEEKLY CAPACITY", Tag = "muted", AutoSize = true, Location = new Point(36, 104), Font = new Font("Segoe UI", 16, FontStyle.Regular, GraphicsUnit.Pixel), ForeColor = Color.LightSteelBlue });
        ...
        header.Controls.Add(new Label { Text = "5-HOUR CAPACITY", Tag = "muted", AutoSize = true, Location = new Point(36, 238), Font = new Font("Segoe UI", 16, FontStyle.Regular, GraphicsUnit.Pixel), ForeColor = Color.FromArgb(140, 190, 245) });
        ...
        var sessionTrack = new Panel { Location = new Point(36, 314), Size = new Size(688, 20), BackColor = Color.FromArgb(25, 45, 70) }; sessionTrack.Tag = "track"; sessionTrack.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top; sessionBar = new Panel { Tag = "session", Location = new Point(0, 0), Height = 20, BackColor = Color.FromArgb(45, 155, 255) }; sessionTrack.Controls.Add(sessionBar); sessionBarText = new Label { Dock = DockStyle.Fill, TextAlign = ContentAlignment.MiddleCenter, Font = new Font("Segoe UI", 13, FontStyle.Bold, GraphicsUnit.Pixel), ForeColor = Color.Black, BackColor = Color.Transparent };  header.Controls.Add(sessionTrack);
        canvas = new GraphCanvas(); canvas.Dock = DockStyle.Fill; canvas.Current = current; canvas.History = history;
        var footer = new Panel { Dock = DockStyle.Bottom, Height = 118, BackColor = Color.Black };
        refreshValue = new Label { AutoSize = true, Location = new Point(36, 14), Font = new Font("Segoe UI", 15, FontStyle.Regular, GraphicsUnit.Pixel), ForeColor = Color.FromArgb(45, 155, 255) }; footer.Controls.Add(refreshValue);
        graphValue = new Label { AutoSize = true, Location = new Point(440, 14), Anchor = AnchorStyles.Top | AnchorStyles.Right, Font = new Font("Segoe UI", 15, FontStyle.Regular, GraphicsUnit.Pixel), ForeColor = Color.FromArgb(45, 155, 255) }; footer.Controls.Add(graphValue);
        var analyticsValue = UiIcons.CreateSwapButton(); analyticsValue.Location = new Point((footer.Width - analyticsValue.Width) / 2, 76); footer.Resize += (_, _) => { analyticsValue.Left = (footer.Width - analyticsValue.Width) / 2; graphValue.Left = footer.Width - graphValue.Width - 36; }; analyticsValue.Click += (_, _) => { Close(); showAnalytics(); }; new ToolTip().SetToolTip(analyticsValue, "Switch between limits and usage"); footer.Controls.Add(analyticsValue); analyticsValue.BringToFront();
    ...
    {
        return new Label { Text = $"{(name == "Weekly" ? current.WeeklyRemaining : current.SessionRemaining):0}% remaining", AutoSize = true, Font = new Font("Segoe UI", 21, FontStyle.Bold, GraphicsUnit.Pixel), ForeColor = color };
    }

...
internal static class UiIcons
{
    ...
    {
        var button = new Button { Text = "Swap", Size = new Size(144, 34), FlatStyle = FlatStyle.Flat, BackColor = Color.FromArgb(55, 46, 16), ForeColor = SwitchColor, Font = new Font("Segoe UI", 15, FontStyle.Bold, GraphicsUnit.Pixel), UseCompatibleTextRendering = true, Cursor = Cursors.Hand };
...
internal sealed class GraphForm : Form
{
    ...
    public GraphForm(UsageSnapshot current, List<UsageSnapshot> history, int refreshMinutes, int graphDays, Action<int> refreshChanged, Action<int> durationChanged, ResetData? resetData, Action showAnalytics)
    {
        ...
        header.Controls.Add(new Label { Text = "5-HOUR CAPACITY", Tag = "muted", AutoSize = true, Location = new Point(36, 238), Font = new Font("Segoe UI", 18, FontStyle.Regular, GraphicsUnit.Pixel), ForeColor = Color.FromArgb(140, 190, 245) });
        ...
        refreshValue = new Label { AutoSize = true, Location = new Point(36, 14), Font = new Font("Segoe UI", 17, FontStyle.Regular, GraphicsUnit.Pixel), ForeColor = Color.FromArgb(45, 155, 255) }; footer.Controls.Add(refreshValue);
        graphValue = new Label { AutoSize = true, Location = new Point(440, 14), Anchor = AnchorStyles.Top | AnchorStyles.Right, Font = new Font("Segoe UI", 17, FontStyle.Regular, GraphicsUnit.Pixel), ForeColor = Color.FromArgb(45, 155, 255) }; footer.Controls.Add(graphValue);
